...
> **상태: 아카이브 (2022.04.08 – 2022.12.15).** 이 README는 2026년에 시스템을 *정확하게* 기록하기 위해 개정되었으며, 사후에 발견한 방법론적 한계까지 그대로 담고 있습니다. 이 한계들은 데이터 분할·라벨·평가를 처음부터 다시 설계한 후속 프로젝트 **[nOOnchi_v2](https://github.com/pmy02/nOOnchi_v2)** <!-- TODO: 후속 리포 푸시 후 URL 갱신 --> 의 출발점이 되었습니다.
